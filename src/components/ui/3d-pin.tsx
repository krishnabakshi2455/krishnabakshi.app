...
export const PinContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative group/pin z-50 cursor-pointer md:mt-20 md:w-1/2 w-full h-screen md:h-96",
        containerClassName
      )}
...
export const PinPerspective = ({
  ...
  return (
    <motion.div
      className="w-20 h-80 flex items-center justify-center opacity-0 group-hover/pin:opacity-100 z-[60] transition duration-500"
    >
      <div className="w-full h-full -mt-7 flex-none inset-0">
        <div className="absolute top-0 inset-x-0 flex justify-center pointer-events-auto">
          ...
          >
            <span className="relative z-20 text-white underline text-xs font-bold inline-block py-0.5">
              {title}
            </span>
