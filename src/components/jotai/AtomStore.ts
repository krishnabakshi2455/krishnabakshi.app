...
import { getlanguages, getlibrariesframeworks, getbackend, getdatabase, gettools, getexperience, geteducation, getprojects, gethomeprojects, getBlog, getBlogs } from "@/lib/sanity/utils";
